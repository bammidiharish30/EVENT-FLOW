...
const LightPillar = ({
    ...
    useEffect(() => {
        ...
        const qualitySettings = {
            low: { iterations: 16, waveIterations: 1, pixelRatio: 0.4, precision: 'mediump', stepMultiplier: 1.8 },
        ...
        return (
            <div
                ...
                style={{
                    ...
                    color: '#666', fontSize: '0.875rem', mixBlendMode
                }}
            >
                WebGL not supported
            </div>
